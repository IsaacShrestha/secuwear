...
def main():
	...
	pcaps = Pcaps('http://localhost:8000/api/session/', 'secuwear', 'secuwear', 'http://localhost:8000/api/events')
	...
	# else:
	pcaps.validatePacket(arguments['<handle_type>'],arguments['<handle_path>'], arguments['<experiment_id>'], 1, 2, 2)
